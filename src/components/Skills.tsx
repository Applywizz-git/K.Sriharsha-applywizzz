...
const Skills = () => {
  ...
  const skillCategories = [
  {
    ...
    icon: Code,
    color: 'from-blue-500 to-blue-700',
    skills: ['Python', 'SQL', 'T-SQL', 'PySpark', 'Bash'],
    proficiency: 95
  },
  {
    title: 'Big Data & ETL Tools',
    icon: Database,
    color: 'from-green-500 to-green-700',
    skills: ['Apache Spark', 'Hadoop', 'Hive', 'Kafka', 'Airflow'],
    proficiency: 92
  },
  {
    title: 'Cloud Platforms',
    icon: Cloud,
    color: 'from-purple-500 to-purple-700',
    skills: ['AWS', 'S3', 'Redshift', 'Azure', 'Databricks'],
    proficiency: 90
  },
  {
    title: 'Databases',
    icon: Server,
    color: 'from-orange-500 to-orange-700',
    skills: ['MySQL', 'PostgreSQL', 'MongoDB', 'Snowflake', 'Oracle'],
    proficiency: 88
  },
  {
    title: 'Visualization & BI',
    icon: BarChart3,
    color: 'from-pink-500 to-pink-700',
    skills: ['Power BI', 'Tableau', 'Looker', 'Plotly', 'Seaborn'],
    proficiency: 85
  },
  {
    title: 'ML & Data Science',
  ...
  },
  {
    ...
    icon: Cog,
    color: 'from-gray-500 to-gray-700',
    skills: ['Linux', 'Windows', 'MacOS', 'VS Code', 'Jupyter Notebook'],
    proficiency: 90
  }
];
